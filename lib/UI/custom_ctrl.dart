                ...
                children: [
                  Container(
                    ...
                    decoration: 
                      BoxDecoration(
                        borderRadius: BorderRadius.circular(12),
                        color: Color.fromARGB(255, 180, 154, 154)),
            ...
            child: Text(
              ...
              :Container(
                ...
                decoration: 
                  BoxDecoration(
                    borderRadius: BorderRadius.circular(12),
                    color: Color.fromARGB(255, 255, 146, 211)),
    ...
    return Container(
      ...
      child: Center(
        child: Text(textButton,
          style: const TextStyle(color: Color.fromARGB(255, 220, 110, 169),
                          fontSize: 20,),
          ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Color.fromARGB(255, 237, 128, 185),
        borderRadius: BorderRadius.circular(14),
        border: Border.all(color: Color.fromARGB(255, 237, 148, 212)),
      ),
      child: TextField(
...
class CustomSpinner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      height: size.height,
      width: size.width,
      color: Color.fromARGB(255, 241, 132, 230).withOpacity(0.5),
      child: const Center(
        child: Image(
          width: 50,
