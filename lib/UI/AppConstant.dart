...
class AppConstant {
  ...
  static TextStyle textbody = TextStyle(
    color: Color.fromARGB(255, 248, 158, 227),
    fontSize: 16,
  );
  ...
  static TextStyle textbodyfocus = TextStyle(
    color: Color.fromARGB(255, 240, 133, 235),
    fontSize: 20,
  );
